...
export const MOCK_PROFILE: ProfileBio = {
  full_name: 'Bhisma',
  headline: 'Web developer · UI/UX designer · Kreator konten',
  headline_en: 'Web developer · UI/UX designer · Content creator',
  bio_summary: 'Saya mengerjakan riset dan desain antarmuka, lalu membangunnya dengan Next.js dan Supabase.',
  bio_summary_en: 'I research and design interfaces, then build them with Next.js and Supabase.',
  status_badge: 'Terbuka untuk kerja penuh waktu & freelance',
  status_badge_en: 'Open to full-time roles & freelance',
  cv_pdf_url: '#',
  social_links: {
