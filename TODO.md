...
## Phase 3.5: Redesain (2026-09-25)
- [x] PRODUCT.md & DESIGN.md (Impeccable)
- [x] Halaman publik: tema terang Apple/Stripe, hapus glow/glass/statistik palsu
- [x] Admin: login ditulis ulang, dashboard disesuaikan ke token baru
- [ ] Ganti proyek & sertifikat contoh dengan karya asli, lalu set `PORTFOLIO_CONTENT_READY=true`
- [ ] Upload CV PDF lewat admin (tombol CV muncul otomatis)
- [ ] Ganti foto profil dengan versi tanpa watermark
- [ ] Rapikan dashboard admin (`/impeccable polish`): tombol pil, teks minimal 13px, ConfirmModal pakai Dialog bersama
